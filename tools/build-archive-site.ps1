  ...
  <main>
    <div class="library-grid">
      ...
      <article class="library-card private-credit">
        <img class="library-cover" src="assets/figures/private_credit_risk_curve/floating_rate_fault_line_art_v2.png" alt="The Floating-Rate Fault Line title artwork">
